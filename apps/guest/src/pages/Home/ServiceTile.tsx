...
export const ServiceTile: React.FC<ServiceTileProps> = ({
  ...
  return (
    <div
      onClick={onClick}
      className="bg-white dark:bg-[#1a1d27] border border-gray-100 dark:border-white/10 rounded-3xl p-6 shadow-sm cursor-pointer hover:shadow-md dark:hover:bg-[#1f2333] transition-all active:scale-95 flex flex-col justify-between h-40 group"
    >
