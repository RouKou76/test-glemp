    ...
    <BottomSheet open={open} onClose={handleClose} title="Минибар">
      ...
      {step === 'success' && (
        <div className="p-6 text-center space-y-4">
          ...
          <div><p className="text-gray-800 dark:text-white font-bold text-lg">Заказ принят!</p><p className="text-gray-600 dark:text-white/60 text-sm mt-1">Доставим в ближайшее время.</p></div>
