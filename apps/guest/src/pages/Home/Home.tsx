    ...
    <div className="p-8 animate-slide-up">
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div onClick={() => setActiveModal('gates')}
          ...
          <div className="p-3 bg-white/20 rounded-2xl w-fit text-white"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 9.9-1"/></svg></div>
