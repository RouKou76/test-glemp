  ...
  return (
    <div className="p-8 animate-slide-up">
      <div className="flex items-center justify-between mb-8">
        ...
        <button onClick={toggle} className="p-2 rounded-full bg-gray-200 dark:bg-white/10 text-gray-600 dark:text-white/80 hover:bg-gray-300 dark:hover:bg-white/20 transition-colors">
          {theme === 'light' ? (
      ...
      <div className="grid grid-cols-2 gap-6 mb-8">
        <div className="bg-white dark:bg-[#1a1d27] p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-white/10 transition-colors">
          <h3 className="text-gray-600 dark:text-white/80 text-sm font-semibold mb-2 uppercase tracking-wider">Связь с администратором</h3>
          <p className="text-xl font-bold text-gray-800 dark:text-white">+7 (999) 123-45-67</p>
        </div>
        <div className="bg-white dark:bg-[#1a1d27] p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-white/10 transition-colors">
          <h3 className="text-gray-600 dark:text-white/80 text-sm font-semibold mb-2 uppercase tracking-wider">Wi-Fi Подключение</h3>
