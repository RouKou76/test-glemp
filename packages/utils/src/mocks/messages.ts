...
export const mockMessages: Message[] = [
  ...
  { id: 'msg2', houseId: 'h1', sender: 'admin', text: 'Конечно, принесём в течение 15 минут!', timestamp: '2026-06-15T08:01:00Z', read: true },
  ...
  { id: 'msg5', houseId: 'h2', sender: 'admin', text: 'Hi! Checkout is at 12:00. Let us know if you need a later time.', timestamp: '2026-06-15T09:16:00Z', read: false },
]
